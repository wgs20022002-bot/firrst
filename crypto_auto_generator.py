...
CRYPTO_VIP_KEYWORDS = {
    ...
    "📊 Cathie Wood (ARK)":      ["cathie wood", "ark invest", "ark investment"],
    ...
    "📊 Mike Novogratz (Galaxy)": ["novogratz", "galaxy digital"],
    "📊 Dan Tapiero":            ["dan tapiero", "tapiero", "10t holdings"],
    "📊 Mark Yusko":             ["mark yusko", "yusko", "morgan creek"],
    "📊 Bill Miller":            ["bill miller", "miller value"],
    "📊 Paul Singer (Elliott)":  ["paul singer", "elliott management"],
    "📊 Bill Ackman (Pershing)": ["bill ackman", "ackman", "pershing square"],
    "📊 Chamath Palihapitiya":   ["chamath", "palihapitiya", "social capital"],
    "📊 Naval Ravikant":         ["naval ravikant", "naval "],
    "📊 Robert Kiyosaki":        ["kiyosaki", "rich dad"],
    "📊 Jim Rogers":             ["jim rogers"],
    "📊 Jurrien Timmer (Fidelity)": ["jurrien timmer", "timmer fidelity"],
    "📊 Mike McGlone (Bloomberg)": ["mike mcglone", "mcglone bloomberg"],
    "📊 Matt Hougan (Bitwise)":  ["matt hougan", "hougan bitwise"],
    "📊 Hunter Horsley (Bitwise)": ["hunter horsley", "horsley bitwise"],
    "📊 Ric Edelman":            ["ric edelman", "edelman financial"],
    "📊 Tom Sosnoff (Tastytrade)": ["tom sosnoff", "sosnoff", "tastytrade"],
    "📊 Kevin O'Leary":          ["kevin o'leary", "mr wonderful", "kevin oleary"],
    "📊 Anthony Scaramucci":     ["scaramucci", "skybridge"],
    "📊 James Lavish":           ["james lavish", "lavish"],
    "📊 Dylan LeClair":          ["dylan leclair", "leclair"],
    "📊 Jesse Myers (Croesus)":  ["jesse myers", "croesus bitcoin"],
    "📊 Willy Woo (온체인)":     ["willy woo", "woobull"],
    "📊 PlanB (S2F)":            ["planb", "stock to flow", "s2f model"],
    "📊 Benjamin Cowen":         ["benjamin cowen", "intothecryptoverse"],
    "📊 Arthur Hayes (BitMEX)":  ["arthur hayes", "bitmex founder"],
    "📊 Mark Moss":              ["mark moss"],
    "📊 Lark Davis":             ["lark davis"],
    "📊 Guy (Coin Bureau)":      ["coin bureau", "guy coin bureau"],
    # ── 🏢 거래소 / 기업 CEO ──
